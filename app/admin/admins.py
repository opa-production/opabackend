...
from app.auth import get_current_admin, get_password_hash, verify_password, get_admin_by_email
...
@router.post("/admin/admins", response_model=AdminDetailResponse, status_code=status.HTTP_201_CREATED)
