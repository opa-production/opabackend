...
def generate_file_path(
    user_id: int, category: str, subcategory: str, filename: str
) -> str:
    """
...
async def upload_file_to_storage(
    bucket_name: str, file_path: str, file_data: bytes, content_type: str = "image/jpeg"
) -> dict:
    """
...
async def list_user_files(
    bucket_name: str, user_id: int, category: Optional[str] = None
) -> list:
    """
...
def collect_storage_file_paths_http(
    bucket_name: str, base_folder: str, max_depth: int = 8
) -> list:
    """
