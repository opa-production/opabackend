...
def build_agreement_pdf(booking, paid_payment=None) -> bytes:
    ...
    doc = SimpleDocTemplate(
        ...
        author="Ardena Platforms Africa Ltd",
    )
    ...
    # ── HEADER ──────────────────────────────────────────────────────────────
    story.append(Paragraph("ARDENA PLATFORMS AFRICA LTD", st["doc_title"]))
    ...
    story.append(Paragraph(
        ...
        "identified below and facilitated by Ardena Platforms Africa Ltd as the platform operator. "
    ...
    story.append(_info_table([
        ["Company", "Ardena Platforms Africa Ltd"],
        ["Role", "Marketplace Platform Operator"],
        ["Email", "hello@ardena.co.ke"],
        ["Website", "www.ardena.co.ke"],
    ...
    terms = [
        ...
        ("6.10 Dispute Resolution",
         ...
         "dispute resolution process via hello@ardena.co.ke. "
        ...
        ("6.11 Platform Role",
         "Ardena Platforms Africa Ltd acts solely as a technology marketplace connecting Vehicle Owners and Renters. "
    ...
    story.append(Paragraph(
        ...
        "the vehicle and confirming the booking on the platform. Ardena Platforms Africa Ltd countersigns as platform "
    ...
    platform_cell = _sig_cell("Ardena Platforms Africa Ltd", "Countersigned as Platform Operator",
    ...
    story.append(Paragraph(
        ...
        f"Reference: {booking_ref}  ·  hello@ardena.co.ke  ·  www.ardena.co.ke",
        st["footer"]))
