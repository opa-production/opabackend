...
from app.models import Host, SupportConversation, SupportMessage
...
def _message_to_response(
    db_message: SupportMessage, host: Host = None, admin_name: str = None
) -> SupportMessageResponse:
...
async def get_support_conversation(
    ...
    for msg in messages:
        ...
        message_list.append(
            _message_to_response(msg, host=current_host, admin_name=admin_name)
        )
