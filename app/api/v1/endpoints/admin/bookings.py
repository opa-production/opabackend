...
async def list_bookings(
    ...
    search: Optional[str] = Query(None, description="Search by client name, host name, or car name"),
...
async def get_booking_stats(
    ...
    return {
        ...
        "revenue": {
            ...
            "average_booking_value": float(avg_booking_value) if avg_booking_value else 0
        },
        "recent_trends": {
