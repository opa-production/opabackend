"""
Expo push token registration endpoints for clients.

The React Native / Expo app calls POST /client/push-token right after login
(or whenever Expo gives a new token). On logout it calls DELETE to unregister.
"""
...
from app.models import Client, ClientPushToken
