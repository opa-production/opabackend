...
from app.models import Host, Client, PaymentMethod, PaymentMethodType
...
from app.auth import get_current_host, get_current_client, get_password_hash
...
@router.post("/client/payment-methods/mpesa", response_model=PaymentMethodResponse, status_code=status.HTTP_201_CREATED)
...
@router.post("/client/payment-methods/card", response_model=PaymentMethodResponse, status_code=status.HTTP_201_CREATED)
...
@router.get("/client/payment-methods/{payment_method_id}", response_model=PaymentMethodResponse)
...
@router.delete("/client/payment-methods/{payment_method_id}", status_code=status.HTTP_204_NO_CONTENT)
...
@router.put("/client/payment-methods/{payment_method_id}/default", response_model=PaymentMethodResponse)
