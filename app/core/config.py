...
class Settings(BaseSettings):
    ...
    CLIENT_PASSWORD_RESET_WEB_URL: Optional[str] = (
        "https://ardena.co.ke/reset-password.html"
    )
...
if settings.SENDGRID_API_KEY:
    logger.info(
        f"SENDGRID_API_KEY loaded successfully (length: {len(settings.SENDGRID_API_KEY)})"
    )
else:
